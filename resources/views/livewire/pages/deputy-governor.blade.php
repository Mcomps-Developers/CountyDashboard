        ...
        <div class="row align-items-center">
            <div class="col-sm-12">
                <div class="page-sub-header">
                    ...
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item active">The Deputy Governor</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="card comman-shadow">
                <div class="card-body">
                    <form wire:submit.prevent='saveChanges'>
                        <div class="row">
                            <div class="col-12">
                                <h5 class="form-title student-info">Manage The Deputy Governor Page <span><a
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group local-forms" wire:ignore>
                                    <label>About </label>
                                    <textarea id="about"
                                        placeholder="Write about the The Deputy Governor's agenda, manifesto, education background, profesional..."
