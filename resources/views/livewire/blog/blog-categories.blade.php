<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Blogging</h3>
                <ul class="breadcrumb">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="javascript:void(0);" class="btn btn-outline-primary me-2"><i
                                    ...
                                    Download</a>
                                <a href="{{ route('blog.category.add') }}" class="btn btn-primary"><i
                                ...
                                @foreach ($categories as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('blog.category',['slug'=>$item->slug])}}" style="padding-left: 6px;"><i class="fa fa-list text-success"></i></a>
                                            <a href="javascript:void(0);"
                                                wire:target='deleteCategory({{ $item->id }})'
