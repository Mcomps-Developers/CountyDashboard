<div class="header">
    ...
    <div class="header-left">
        ...
        <a href="/" class="logo logo-small">
            <img src="{{ asset('assets/logoSmall.png') }}" alt="Logo" width="30" height="30">
        </a>
    </div>
    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow new-user-menus">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                <div class="user-img">
                    <img class="rounded-circle" src="{{ Auth::user()->profile_photo_url }}" width="31"
                        alt="Ryan Taylor">
                    <div class="user-text">
                        <h6 style="text-transform: capitalize">Hi {{ Auth::user()->last_name }}</h6>
                        <p class="mb-0 text-muted" style="text-transform: uppercase">{{ Auth::user()->utype }}</p>
                    </div>
                </div>
            </a>
            <div class="dropdown-menu">
                <div class="user-header">
                    ...
                    <div class="user-text">
                        <h6 style="text-transform: capitalize">{{ Auth::user()->last_name }}</h6>
                        <p class="mb-0 text-muted" style="text-transform: uppercase">{{ Auth::user()->utype }}</p>
                    </div>
                </div>
