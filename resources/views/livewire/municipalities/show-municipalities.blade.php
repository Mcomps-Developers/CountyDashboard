                            ...
                            <tbody>
                                @foreach ($municipalities as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('municipality.edit', ['municipality_id' => $item->id]) }}"><i
                                                    class="fa fa-edit"></i></a>
                                            <a href="" style="padding-left: 6px;"><i
                                                    class="fa fa-list text-success"></i></a>
                                            <a href="javascript:void(0);"
                                                wire:target='deleteMunicipality({{ $item->id }})'
                                                wire:click.prevent='deleteMunicipality({{ $item->id }})'
