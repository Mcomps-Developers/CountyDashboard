                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control"
                                            wire:model.live='cecm_department_phone'>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            <div class="change-photo-btn">
                                                <div>
                                                    @if ($cecm_photo)
                                                        <img src="{{ $cecm_photo->temporaryUrl() }}" width="200"
                                                            height="150" alt="">
                                                    @else
                                                        <p>No Image has been uploaded</p>
                                                    @endif
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group" wire:ignore>
                                        ...
                                        <textarea id="about_cecm" class="form-control" wire:model.live='about_cecm' columns="2" rows="4"></textarea>
                                    </div>
                                    @error('about_cecm')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
